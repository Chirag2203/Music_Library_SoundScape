...
<head>
  ...
  <style>
    ...
    img:hover {
      box-shadow: 0px 2px 5px 2px rgb(139, 2, 48);
    }
...
<body>
  <center>
    <h1 id="myHeader"><img src="images/Logo_Main.png" height="85" width="85"> Sound Scape</h1>
  </center>
  <br>
  <div class="all">
  ...
  <div class="about" id="team">
    <footer>
      <!-- copy right -->
      <p class="copy-right" style="font-size: 15px;">&copy; copyright by Sound Scape, All rights are reserved.
      </p>
  </div>
  </footer>
