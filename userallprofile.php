...
<body>
    <center>
        <h1 id="myHeader" style="color: black;"><img src="images/Logo_Main.png" height="85" width="85"> Sound Scape</h1>
    </center>
    <br>
    ...
    ?><table class="table table-bordered">
        ...
        <?php }
            ...
            <footer>
                <!-- copy right -->
                <p class="copy-right" style="font-size: 20px;">&copy; copyright by Sound Scape, All rights are reserved.
                </p>
                </div>
            </footer>
