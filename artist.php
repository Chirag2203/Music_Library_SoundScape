...
<head>
    ...
    <link rel="icon" href="images/Logo_Main.png" type="image/png">
    ...
    <style>
        ...
        .display form input[type="submit"] {
            background-color: #252c37;
            font-size: 20px;
            color: white;
            border-radius: 10px;
...
<body>
    <div class="artist">
        <div class="login-msg">
            <img src="images/Logo_Main.png"><br>
            <h1> Sound Scape </h1>
            <br>
        ...
        <div class="display">
            ...
            <h1><b> Welcome! Upload a song </b></h1>
            <form action="artist.php" method="POST" enctype="multipart/form-data">
                <div class="cont">
                <div class="form-group">
                    <lable>Song Name :</lable><br>
                    <input type="text" name="song_name" value="" class="form-control-file" >
                </div>
                <div class="form-group">
