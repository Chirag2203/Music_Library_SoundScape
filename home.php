		...
		<div class="container ">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					<!-- logo image -->
					<img class="img-responsive" src="images/Logo_Main.png" alt="" style="height:100px;width:100px;" />
				</a>
			</div>

			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<h1 style="color:white; font-family: Perpetua; font-size: 65px;">Sound Scape</h1>
					...
					<div class="col-md-4 col-sm-4">
						<div class="what-we-item ">
							...
							<p style="font-size: 21px; font-family: book antiqua; font-weight: bold;">This website made as a
								<strong class="theme-color credits">Project</strong> by 
								<p style="font-size: 21px; font-family: book antiqua; font-weight: bold;">
									1. Achyut Agarwal <br>2. Chirag Rajput <br>3. Garvit Goyal
								</p>
					...
					<div class="col-md-4 col-sm-4">
						<div class="what-we-item ">
							...
							<p style="font-size: 21px; font-family: book antiqua;font-weight: bold;">You can also visit
								<strong class="theme-color">Recenty Uploaded Songs</strong> and explore Artist and thier songs.
							<br>
							Are you a singer? <strong class="theme-color">Upload your songs as an Artist </strong> from your profile.
						</p>
						</div>
					</div>
				</div>
